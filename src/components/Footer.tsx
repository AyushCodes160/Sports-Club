    ...
    <footer className="bg-gray-900 text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <NavLink to="/sports" className="text-gray-400 hover:text-white transition-colors">
                  Sports
                </NavLink>
              </li>
              <li>
                <NavLink to="/gallery" className="text-gray-400 hover:text-white transition-colors">
                  Gallery
                </NavLink>
              </li>
              <li>
                <NavLink to="/leaders" className="text-gray-400 hover:text-white transition-colors">
                  Leaders
                </NavLink>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">123 University Ave, College Town, CT 10101</span>
              </li>
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">info@collegesports.edu</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500">
          <p>&copy; {new Date().getFullYear()} College Sports Club. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
